...
namespace LW.BkEndDb.Migrations
{
    ...
    [Migration("20230718110743_remove static status name and tranzaction name")]
    partial class removestaticstatusnameandtranzactionname
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LW.BkEndModel.FirmaDiscount", b =>
                {
                    ...
                    b.Property<bool>("IsActiveSecondary")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("LW.BkEndModel.PreferinteHybrid", b =>
                {
                    ...
                    b.Navigation("MyConexiuniConturi");
                });
