...
namespace SqlDummyData
{
    ...
    {
        // dev local
        //public static string DbConnString = "Data Source=.;Initial Catalog=lwins;Integrated Security=true;TrustServerCertificate=true;";
        // dev azure
        public static string DbConnString =
            "Server=tcp:lw-dbserver.database.windows.net,1433;Initial Catalog=lw-database;Persist Security Info=False;User ID=lwdbadmin;Password=Vib3r0n3;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
        ...
        {
            var conexCont = new ConexiuniConturi { UserId = user.Id, };
            return conexCont;
        }
        ...
        private FirmaDiscount GenerateFirmaDiscount(ProfilCont profilCont)
        {
            var firmaDiscountFaker = new Faker<FirmaDiscount>()
                ...
                .RuleFor(
                    x => x.Address,
                    x => $"{x.Person.Address.City}, {x.Person.Address.Street}"
                );
