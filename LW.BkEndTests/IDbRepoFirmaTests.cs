...
namespace LW.BkEndTests
{
    public class IDbRepoFirmaTests
    {
        ...
        public void GetAllDocumenteWFP_ReturnsExpectedResult()
        {
            ...
            mockRepo.Setup(repo => repo.GetAllDocumenteWFP(testGuid)).Returns(expected);
        ...
        public async Task UpdateDocStatusAsync_ReturnsExpectedResult()
        {
            ...
            mockRepo
                .Setup(repo => repo.UpdateDocStatusAsync(documente, status))
        ...
        public void GetDashboardInfo_ReturnsExpectedResult()
        {
            ...
            mockRepo.Setup(repo => repo.GetDashboardInfo(testGuid)).Returns(expected);
        ...
        public void GetFirmaDiscountId_ReturnsExpectedResult()
        {
            ...
            mockRepo.Setup(repo => repo.GetFirmaDiscountId(testGuid)).Returns(expected);
        ...
        public void GetAllHybrids_ReturnsExpectedResult()
        {
            ...
            mockRepo.Setup(repo => repo.GetAllHybrids(testGuid)).Returns(expected);
        ...
        public async Task DeleteHybrid_ReturnsExpectedResult()
        {
            ...
            mockRepo
                .Setup(repo => repo.DeleteHybrid(firmaDiscountId, groupId))
                .ReturnsAsync(expected);
